...
Самый очевидный способ, но наимоблее используемый в практике - модуль View. Такой подход хорошо интегрируется с другими подходами. Например, у нас может быть модуль ячейки внутри которой есть подмодуль галлереи или видео плеера. Такие подмодули могут быть легко переиспользуемы на других экранах.
